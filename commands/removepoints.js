...
{
    name: "removepoints",
    description: "decrease a character's points total.",
    execute(message, args)
    {
        ...
        message.reply("Removed " + args[1] + " points from character with id "+ args[0] + ", for a new total of " + character.points + ".");
    }
}